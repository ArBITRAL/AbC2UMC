...
yystate(36, [C|Ics], Line, Tlen, _, _) when C >= 0, C =< 9 ->
    yystate(12, Ics, Line, Tlen+1, 7, Tlen);
yystate(36, [C|Ics], Line, Tlen, _, _) when C >= 11, C =< 47 ->
    yystate(12, Ics, Line, Tlen+1, 7, Tlen);
yystate(36, [C|Ics], Line, Tlen, _, _) when C >= 48, C =< 57 ->
    yystate(28, Ics, Line, Tlen+1, 7, Tlen);
yystate(36, [C|Ics], Line, Tlen, _, _) when C >= 58, C =< 64 ->
    yystate(12, Ics, Line, Tlen+1, 7, Tlen);
yystate(36, [C|Ics], Line, Tlen, _, _) when C >= 65, C =< 90 ->
    yystate(28, Ics, Line, Tlen+1, 7, Tlen);
yystate(36, [C|Ics], Line, Tlen, _, _) when C >= 91, C =< 94 ->
    yystate(12, Ics, Line, Tlen+1, 7, Tlen);
...
yystate(29, [42|Ics], Line, Tlen, _, _) ->
    yystate(25, Ics, Line, Tlen+1, 4, Tlen);
yystate(29, [41|Ics], Line, Tlen, _, _) ->
    yystate(25, Ics, Line, Tlen+1, 4, Tlen);
yystate(29, [40|Ics], Line, Tlen, _, _) ->
    yystate(25, Ics, Line, Tlen+1, 4, Tlen);
...
yystate(29, [10|Ics], Line, Tlen, _, _) ->
    yystate(33, Ics, Line+1, Tlen+1, 4, Tlen);
...
yystate(29, [C|Ics], Line, Tlen, _, _) when C >= 98, C =< 101 ->
    yystate(0, Ics, Line, Tlen+1, 4, Tlen);
yystate(29, [C|Ics], Line, Tlen, _, _) when C >= 103, C =< 109 ->
    yystate(0, Ics, Line, Tlen+1, 4, Tlen);
yystate(29, [C|Ics], Line, Tlen, _, _) when C >= 112, C =< 115 ->
    yystate(0, Ics, Line, Tlen+1, 4, Tlen);
...
yystate(27, [C|Ics], Line, Tlen, _, _) when C >= 65, C =< 90 ->
    yystate(0, Ics, Line, Tlen+1, 7, Tlen);
yystate(27, [C|Ics], Line, Tlen, _, _) when C >= 98, C =< 101 ->
    yystate(0, Ics, Line, Tlen+1, 7, Tlen);
...
-file("./scanner.xrl", 26).
yyaction_8(TokenChars, TokenLen, TokenLine) ->
     { token, { token, TokenLine, strip (TokenChars, TokenLen) } } .
